...
CREATE INDEX IF NOT EXISTS "login_logs_login_time_idx" ON "login_logs" ("login_time" DESC);
CREATE INDEX IF NOT EXISTS "login_logs_ip_address_idx" ON "login_logs" ("ip_address");
CREATE INDEX IF NOT EXISTS "login_logs_session_id_idx" ON "login_logs" ("session_id");
CREATE INDEX IF NOT EXISTS "login_logs_is_active_idx" ON "login_logs" ("is_active");